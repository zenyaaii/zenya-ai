 ...
 *
 * GENERATED FROM app/(main)/terms/page.tsx and then reviewed by hand. The
...
export const SECTIONS = [
  ...
  },
  {
    "id": "s-5",
    "level": 2,
    "text": "٥. الاستخدام المقبول"
  },
  {
    "id": "s-6",
    "level": 2,
    "text": "٦. التسعير والفوترة"
  },
  {
    "id": "s-7",
    "level": 2,
    "text": "٧. الاسترداد وحق الانسحاب"
  },
  {
    "id": "s-8",
    "level": 2,
    "text": "٨. المحتوى المُولّد — الملكية والترخيص"
  },
  {
    "id": "s-9",
    "level": 2,
    "text": "٩. خدمات الأطراف الخارجية"
  },
  {
    "id": "s-10",
    "level": 2,
    "text": "١٠. إخلاء المسؤولية عن الذكاء الاصطناعي والمخرجات"
  },
  {
    "id": "s-11",
    "level": 2,
    "text": "١١. توافر الخدمة"
  },
  {
    "id": "s-12",
    "level": 2,
  ...
  },
  {
    "id": "s-15",
    "level": 2,
    "text": "١٥. التغييرات على الخدمة أو الشروط"
  },
  {
    "id": "s-16",
    "level": 2,
    "text": "١٦. القانون الحاكم والنزاعات"
  },
  {
    "id": "s-17",
    "level": 2,
    "text": "١٧. أحكام متفرّقة"
  },
  {
    "id": "s-18",
    "level": 2,
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>«<strong>الاشتراك المدفوع</strong>» (Starter أو Pro) — اشتراك شهري متجدّد تلقائيًا يفتح الميزات المميّزة طوال فترة اشتراكك الفعّال.</li>
      </ul>

      <h2 id="s-2">٢. الأهلية</h2>
      <p>
      ...
      <h2 id="s-5">٥. الاستخدام المقبول</h2>
      ...
      <ul>
        ...
        <li>تُعالَج المدفوعات بواسطة Stripe. بالاشتراك، فإنك توافق أيضًا على{' '}
          <a href="https://stripe.com/legal/consumer" target="_blank" rel="noopener">شروط Stripe</a>.
        </li>
        <li>قد نُغيّر أسعار الاشتراكات المستقبلية في أي وقت، مع إشعارك مسبقًا قبل تجديد يتأثّر بالتغيير.</li>
      </ul>

      <h2 id="s-7">٧. الاسترداد وحق الانسحاب</h2>
      <p>
        ...
        باستخدام ميزاتك المدفوعة، يسقط حق الانسحاب فيما يتعلّق بذلك
        الأداء.
      </p>

      <h2 id="s-8">٨. المحتوى المُولّد — الملكية والترخيص</h2>
      <ul>
        ...
        <li><strong>المحتوى الديناميكي على شوبيفاي — خدمة مرخّصة:</strong> عندما تنشر قالبًا يعمل على شوبيفاي عبر تطبيق زينيا، يظلّ المحتوى الديناميكي الذي يولّده زينيا ويعرضه (مثل أقسام صفحة المنتج التي يقدّمها تطبيق زينيا) <strong>خدمةً مرخّصة تتطلّب اشتراكًا فعّالًا</strong>. وعند إلغاء اشتراكك أو انتهائه أو إزالة تطبيق زينيا من متجرك، يتوقّف هذا المحتوى الديناميكي عن الظهور تلقائيًا مع بقاء متجرك الأساسي ومنتجاتك كما هي دون مساس. ويمكنك استعادة هذا المحتوى بإعادة تفعيل اشتراك مدفوع. لا يشمل ذلك ملفات التصدير الثابتة التي نزّلتها بالفعل، والتي تبقى ملكك.</li>
      </ul>

      <h2 id="s-9">٩. خدمات الأطراف الخارجية</h2>
      <p>
      ...
      <h2 id="s-10">١٠. إخلاء المسؤولية عن الذكاء الاصطناعي والمخرجات</h2>
      <p>
      ...
      <h2 id="s-13">١٣. تحديد المسؤولية</h2>
      <p>
      ...
      <h2 id="s-15">١٥. التغييرات على الخدمة أو الشروط</h2>
      <p>
      ...
      <h2 id="s-16">١٦. القانون الحاكم والنزاعات</h2>
      <p>
      ...
      <h2 id="s-17">١٧. أحكام متفرّقة</h2>
      <ul>
