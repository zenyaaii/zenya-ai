...
export const metadata: Metadata = {
  ...
  description:
    'زينيا منصّة عربية لإنشاء المواقع بالذكاء الاصطناعي لكل نشاط تجاري. اختر من بين 8 قوالب احترافية — مطاعم، أزياء، تطبيقات، عافية، خدمات والمزيد — اكتب نبذة قصيرة، وتتكفّل زينيا بكتابة المحتوى ونشر الموقع خلال دقائق. ‎14.99$ شهريًا (Starter) أو 24.99$ شهريًا مع استضافة كاملة (Pro).',
