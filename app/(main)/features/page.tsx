...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    body: 'اربط نطاقك الخاص (مثل mystore.com) على خطة Pro مع شهادة SSL وإزالة شارة زينيا — ونمنحك نطاقًا مخصّصًا مجانيًا لسنة كاملة (نطاق قياسي).',
  },
  {
    icon: CreditCard,
...
const FEATURE_FAQS: QA[] = [
  ...
  },
  {
    ...
    a: 'نعم على خطة Pro، مع شهادة SSL وإزالة شارة زينيا. كما نقدّم نطاقًا مخصّصًا مجانيًا لسنة كاملة (نطاق قياسي)، وخصم 30% على النطاقات الأخرى.',
  },
  {
