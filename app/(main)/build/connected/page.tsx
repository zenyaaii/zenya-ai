...
export default function ShopifyConnectedPage() {
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-6">
      <div className="max-w-md rounded-2xl border border-token bg-white p-10 text-center shadow-sm">
        ...
        <p className="mt-4 text-[14.5px] text-muted">يمكنك إغلاق هذا التبويب.</p>
      </div>
    </div>
  )
}
