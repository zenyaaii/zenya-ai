          ...
          {displayProducts.map((product, i) => (
            ...
            >
              <div className="relative aspect-[1/1] overflow-hidden rounded-xl bg-slate-100 mb-4">
                 ...
                 {i === 0 && (
                   <div className="absolute top-2 left-2 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded shadow-sm">SALE</div>
                 )}
              </div>
              <h3 className="font-bold text-slate-900 group-hover:text-blue-600 transition">Demo Product {i + 1}</h3>
