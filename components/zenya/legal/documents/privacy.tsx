...
/**
 * privacy: the live document's clauses, moved without a word changed.
 *
 * GENERATED FROM app/(main)/privacy/page.tsx and then reviewed by hand. The
...
export const SECTIONS = [
  ...
  },
  {
    "id": "s-2",
    "level": 2,
    "text": "٢. البيانات التي نجمعها"
  },
  {
    "id": "s-2-1",
    "level": 3,
    "text": "٢.١ بيانات تقدّمها لنا مباشرة"
  },
  {
    "id": "s-2-2",
    "level": 3,
    "text": "٢.٢ بيانات تُجمع تلقائيًا"
  },
  {
    "id": "s-2-3",
    "level": 3,
    "text": "٢.٣ بيانات نحصل عليها من Shopify (فقط إن ربطت متجرًا)"
  },
  {
    "id": "s-3",
    "level": 2,
    "text": "٣. لماذا نستخدم بياناتك (الأسس القانونية بموجب المادة ٦ من GDPR)"
  },
  {
    "id": "s-4",
    "level": 2,
    "text": "٤. مع من نشارك البيانات (المعالجون الفرعيون)"
  },
  {
    "id": "s-5",
    "level": 2,
    "text": "٥. مدة احتفاظنا ببياناتك"
  },
  {
    "id": "s-6",
    "level": 2,
    "text": "٦. حقوقك بموجب اللائحة العامة لحماية البيانات (GDPR)"
  },
  {
    "id": "s-7",
    "level": 2,
  ...
  },
  {
    "id": "s-10",
    "level": 2,
    "text": "١٠. المعالجة بالذكاء الاصطناعي"
  },
  {
    "id": "s-11",
    "level": 2,
    "text": "١١. التغييرات على هذه السياسة"
  },
  {
    "id": "s-12",
    "level": 2,
...
export default function Doc() {
  return (
    <>
      ...
      <h2 id="s-2">٢. البيانات التي نجمعها</h2>

      <h3 id="s-2-1">٢.١ بيانات تقدّمها لنا مباشرة</h3>
      <ul>
        <li>
      ...
      <h3 id="s-2-2">٢.٢ بيانات تُجمع تلقائيًا</h3>
      <ul>
        <li>
      ...
      <h3 id="s-2-3">٢.٣ بيانات نحصل عليها من Shopify (فقط إن ربطت متجرًا)</h3>
      <ul>
      ...
      <h2 id="s-3">٣. لماذا نستخدم بياناتك (الأسس القانونية بموجب المادة ٦ من GDPR)</h2>
      ...
      <h2 id="s-4">٤. مع من نشارك البيانات (المعالجون الفرعيون)</h2>
      <p>
      ...
      <h2 id="s-5">٥. مدة احتفاظنا ببياناتك</h2>
      <ul>
      ...
      <h2 id="s-6">٦. حقوقك بموجب اللائحة العامة لحماية البيانات (GDPR)</h2>
      <p>يحق لك:</p>
      <ul>
      ...
      <h2 id="s-8">٨. خروقات البيانات</h2>
      <p>
      ...
      <h2 id="s-11">١١. التغييرات على هذه السياسة</h2>
      <p>
