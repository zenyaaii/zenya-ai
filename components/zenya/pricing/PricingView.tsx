...
const NAV: Array<{ href: string; label: string; tray?: boolean; current?: boolean }> = [
  // The candidate catalogue, not the live one. This pointed at /templates because
  ...
  { href: "/templates", label: "القوالب", tray: true },
...
.zp-phone-menu .zp-tray-row { justify-content: flex-start; }
