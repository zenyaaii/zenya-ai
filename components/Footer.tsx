        ...
        <div className="grid gap-10 md:grid-cols-12 md:gap-8">
          ...
          <div className="md:col-span-5">
            ...
            <p className="max-w-sm text-[14px] leading-[1.85] text-muted">
              أوّل شركة إسلامية لإنشاء المواقع بالذكاء الاصطناعي، للأنشطة التجارية
              الحقيقية. ثمانية قوالب احترافية — مطاعم، أزياء، صفحات هبوط للتطبيقات،
              قصص علامات تجارية، مراكز عافية، خدمات، ومتاجر إلكترونية. اكتب نبذة،
              واحصل على موقع مباشر.
            </p>
