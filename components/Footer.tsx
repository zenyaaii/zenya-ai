...
const SOCIALS = [
  { label: 'TikTok',    href: 'https://www.tiktok.com/@zenyaai',    icon: TikTokIcon    },
  { label: 'Instagram', href: 'https://www.instagram.com/zenyaai',  icon: InstagramIcon },
  { label: 'X',         href: 'https://x.com/zenyaai',              icon: XIcon2        },
  { label: 'Facebook',  href: 'https://www.facebook.com/zenyaai',   icon: FacebookIcon  },
]
