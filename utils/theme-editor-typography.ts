/**
 * Shared typography presets — used by every brochure-theme editor.
 *
 * Each preset bundles a heading font + body font + a tracking/weight pair.
 * The editor lets the user pick any of these; each per-theme Preview
 * applies them by overriding its heading/body font tokens.
 *
 * Adding a preset = add to TYPOGRAPHY_PRESETS + add the Google Fonts
 * family to GOOGLE_FAMILIES with the weight range the design needs.
 */
